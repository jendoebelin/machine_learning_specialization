...
def weighted_entropy(y_left, y_right):
    ...
    return p_left * compute_entropy(y_left) + p_right * compute_entropy(y_right)
    
    X_node = sum(y)/len(y)
    y_node = entropy(X_node)
    w_entropy = weighted_entropy(X,y,X_left, y_left, X_right, y_right)
    information_gain = y_node - w_entropy
...
def compute_information_gain(X, y, node_indices, feature):
    ...
    entropy_after = weighted_entropy(y[left_indices], y[right_indices])
